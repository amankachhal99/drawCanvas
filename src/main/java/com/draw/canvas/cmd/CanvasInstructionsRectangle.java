...
import static com.draw.canvas.util.CanvasCostant.CMD_RECTANGLE;
 ...
 */
public class CanvasInstructionsRectangle extends CanvasInstructions {
	...
	public CanvasInstructionsRectangle() {
		name = CMD_RECTANGLE;
	}
	
	public CanvasInstructionsRectangle(int x1, int y1, int x2, int y2, Canvas canvas) {
		this();
		this.x1 = x1;
		this.y1 = y1;
		this.x2 = x2;
